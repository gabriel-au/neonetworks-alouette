...
function funbox_admin_init()
{
    ...
    wp_register_style('custom_funBox_style', plugins_url('custom-fun-box.css', __FILE__));
    wp_register_style('animated_css', plugins_url('animate-custom.css', __FILE__));
    wp_register_script('funbox_admin_js', plugins_url('/js/fun_box_admin.js', __FILE__), array('jquery'));
    wp_register_script('bootstrap_js', plugins_url('/js/bootstrap.min.js', __FILE__), array('jquery'));
...
function funbox_install()
{
    ...
    if ($wpdb->get_var("SHOW TABLES LIKE '$table_name'") != $table_name) {
        $sql = "CREATE TABLE $table_name (
                ...
                c_txt_t VARCHAR(255),
                c_txt_d VARCHAR(255),
                c_txt_fnt_sz VARCHAR(255),
                c_txt_spc VARCHAR(255),
                l_dv VARCHAR(255),
                l_rc_1 VARCHAR(255),
                l_rc_2 VARCHAR(255),
                l_rc_3 VARCHAR(255),
                ...
                l_opc VARCHAR(255),
                l_titl VARCHAR(200),
                l_titl_u VARCHAR(255),
                l_titl_d VARCHAR(255),
                l_titl_l VARCHAR(255),
                l_titl_r VARCHAR(255),
                l_titl_fnt_sz VARCHAR(255),
                l_txt LONGTEXT,
                l_txt_l VARCHAR(255),
                l_txt_r VARCHAR(255),
                l_txt_t VARCHAR(255),
                l_txt_d VARCHAR(255),
                l_txt_fnt_sz VARCHAR(255),
                l_txt_spc VARCHAR(255),
                l_titl_lnk LONGTEXT,
                trans_1 VARCHAR(255),
                trans_2 VARCHAR(255),
                italics_1 VARCHAR(255),
                italics_2 VARCHAR(255),
                italics_3 VARCHAR(255),
                boald_1 VARCHAR(255),
                boald_2 VARCHAR(255),
                boald_3 VARCHAR(255),
        ...
        CHANGE COLUMN c_rc_1 c_rc_1 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_rc_2 c_rc_2 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_rc_3 c_rc_3 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_rc_4 c_rc_4 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_bg_c c_bg_c VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_bd_c c_bd_c VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_ft_c c_ft_c VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_brd c_brd VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_opc c_opc VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_wid c_wid VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_hei c_hei VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_txt c_txt LONGTEXT NULL DEFAULT NULL ,
        CHANGE COLUMN c_txt_l c_txt_l VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_txt_r c_txt_r VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_txt_t c_txt_t VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_txt_d c_txt_d VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_txt_fnt_sz c_txt_fnt_sz VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN c_txt_spc c_txt_spc VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_dv l_dv VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_rc_1 l_rc_1 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_rc_2 l_rc_2 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_rc_3 l_rc_3 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_rc_4 l_rc_4 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_bg_c l_bg_c VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_ft_c l_ft_c VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_tl_c l_tl_c VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_dv_c l_dv_c VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_entr l_entr VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_opc l_opc VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_titl l_titl VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_titl_u l_titl_u VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_titl_d l_titl_d VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_titl_l l_titl_l VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_titl_r l_titl_r VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_titl_fnt_sz l_titl_fnt_sz VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_txt l_txt LONGTEXT NULL DEFAULT NULL ,
        CHANGE COLUMN l_txt_l l_txt_l VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_txt_r l_txt_r VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_txt_t l_txt_t VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_txt_d l_txt_d VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_txt_fnt_sz l_txt_fnt_sz VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_txt_spc l_txt_spc VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN l_titl_lnk l_titl_lnk VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN trans_1 trans_1 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN trans_2 trans_2 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN italics_1 italics_1 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN italics_2 italics_2 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN italics_3 italics_3 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN boald_1 boald_1 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN boald_2 boald_2 VARCHAR(255) NULL DEFAULT NULL ,
        CHANGE COLUMN boald_3 boald_3 VARCHAR(255) NULL DEFAULT NULL ;");
    }
...
function get_a_funbox()
{
    ...
    $results[0]->c_txt= htmlspecialchars_decode($results[0]->c_txt);
    $results[0]->l_titl= htmlspecialchars_decode($results[0]->l_titl);
    $results[0]->l_txt= htmlspecialchars_decode($results[0]->l_txt);
