...
class NextendImage extends NextendCache {
    ...
    function colorizeImage($img, $targetColor, $baseColor) {
        if (!function_exists('imagecreatefrompng') || !function_exists('imagesx') || !function_exists('imagesy') || !function_exists('ImageColorAt') || !function_exists('imagesetpixel') || !function_exists('imagecolorallocatealpha')) {
            return NextendUri::pathToUri($img);
        } else {
